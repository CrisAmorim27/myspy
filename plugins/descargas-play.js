...
const handler = async (m, {conn, command, args, text, usedPrefix}) => {
  if (!text) throw `_*< DESCARGAS - PLAY />*_\n\n*[ ℹ️ ] Você precisa do título ou link do vídeo do YouTube seu burro.*\n\n*[ 💡 ] Exemplo:* _${usedPrefix + command} Good Feeling - Flo Rida_`;
    ...
    if (size >= limit_a2) {  
    await conn.sendMessage(m.chat, {text: `*[ ✔ ] Baixe em ${audio}*`}, {quoted: m});
    return;    
    }     
    ...
    throw '_*< DESCARGAS - PLAY />*_\n\n*[ ℹ️ ] Não deu irmão, tenta mais tarde.*';    
    }}
    if (command == 'play2') {
    try {   
    ...
    throw '_*< DESCARGAS - PLAY />*_\n\n*[ ℹ️ ] Tenta mais tarde, ou pode ter caido a API mesmo*';    
    }
  }
};
